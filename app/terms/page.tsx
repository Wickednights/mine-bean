  ...
  return (
    <div style={{ minHeight: '100vh', background: '#0a0a0a', paddingBottom: isMobile ? '80px' : '0' }}>
      ...
      <div style={{ maxWidth: 1200, margin: '0', padding: isMobile ? '32px 20px 60px' : '48px 40px 80px 160px' }}>
        ...
        <p style={text}>To access the Services, you must use non-custodial wallet software which allows you to interact with the BNB Smart Chain blockchain. Your relationship with your wallet provider is governed by their applicable terms of service.</p>
        ...
        <p style={text}><span style={bold}>Third-Party Risks:</span> The Services rely on third-party technologies (e.g., BNB Smart Chain blockchain, wallet providers, RainbowKit, wagmi). We are not liable for their failures, outages, or vulnerabilities.</p>
